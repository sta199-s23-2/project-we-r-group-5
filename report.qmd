...
However, our hypothesis test does not fully agree that the mean general wealth worth has been consistently increasing. We found that the first dataset comparison (2001 vs. 2014) led to rejection of the null hypothesis, indicating an increase in mean wealth worth. However, the second comparison (1996 vs. 2001) did not provide conclusive evidence of an increase due to potential sample size differences and smaller increases during that time period. It is important to note that only the upper tail of the distribution was considered due to the alternative hypothesis testing greater than 0. Thus, our analysis does not support the conclusion that mean wealth worth per billionaire increased from 1996 to 2001. This test showed a significant increase in mean wealth worth per billionaire from 2001-2014 but not from 1996-2001. Keep in mind that this test was a generalization of total mean wealth worth for each year NOT considering industry.
