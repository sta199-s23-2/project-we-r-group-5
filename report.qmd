...
df_1 <- billionaires|>
  ...
  mutate(continent = if_else(location.region == "East Asia", "Asia",
                     ...
                     if_else(location.region == "Latin America" & location.citizenship == "Mexico", "North America",location.region))))))
...
df_1 |>
  ...
  labs(title = "Relationship Between Wealth Worth and Industry\nAmong the Billionaires in each Continent in 2014", x = "Industry", y = "Wealth Worth(billions)") +
