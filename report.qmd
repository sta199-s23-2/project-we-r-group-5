...
count_billionaires_1996 <- df_1 |>
  filter(year == 1996) |>
  filter(wealth.how.industry != 0) |>
  filter(location.region == "North America") 
nrow(count_billionaires_1996)

count_billionaires_2001 <- df_1 |>
  filter(year == 2001) |>
  filter(wealth.how.industry != 0) |>
  filter(location.region == "North America") 
nrow(count_billionaires_2001)

count_billionaires_2014 <- df_1 |>
  filter(year == 2014) |>
  filter(wealth.how.industry != 0) |>
  filter(location.region == "North America") 
nrow(count_billionaires_2014)
